...
private:
    ...
    void traverseSceneGraph(const uPtr<Node> &node, glm::mat3 trans);
...
signals:
    ...
    void sig_onlyTranslateSpinbox();

    void sig_onlyRotateSpinbox();

    void sig_onyScaleSpinbox();

    void sig_enableAllSpinbox();
